...
namespace Quizzer.Logic.Migrations
{
    ...
    [Migration("20260909173501_punktekurve")]
    partial class punktekurve
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.Base.Game", b =>
                {
                    ...
                    b.Property<Guid?>("ModeratorPlayerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.Base.GameTheme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CellTextColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.QuestionBase", b =>
                {
                    ...
                    b.Property<int>("BuzzerControlsLayout")
                        .HasColumnType("int");

                    b.Property<int>("BuzzerMaxAllowedKeySelect")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("QuestionViewKeyType")
                        .HasColumnType("int");
                    ...
                    b.Property<double>("ScoreReductionFactor")
                        .HasColumnType("float");

                    b.Property<int>("ScoreReductionMode")
                        .HasColumnType("int");

                    b.Property<bool>("ShowTextOnKeySelect")
                        .HasColumnType("bit");

                    b.Property<int>("StepDisplayLayoutMode")
                        .HasColumnType("int");

                    b.Property<int>("Typ")
                        .HasColumnType("int");

                    b.Property<bool>("UseProportionalScoreReductionOnStep")
                        .HasColumnType("bit");

                    b.Property<bool>("UseRandomSequenceOnNoneFinishSteps")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.QuestionTypes.RevealQuestion", b =>
                {
                    b.HasBaseType("Quizzer.DataModels.Models.QuestionBase");
                    ...
                    b.ToTable("RevealQuestion", "question");
                });

            modelBuilder.Entity("Quizzer.DataModels.Models.Base.Game", b =>
                {
                    b.HasOne("Quizzer.DataModels.Models.Base.GameTheme", "GameTheme")
                        .WithMany("Games")
                        .HasForeignKey("GameThemeId");

                    b.HasOne("Quizzer.DataModels.Models.Base.Player", "Moderator")
                        .WithMany()
                        .HasForeignKey("ModeratorPlayerId");
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.QuestionBase", b =>
                {
                    ...
                    b.HasOne("Quizzer.DataModels.Models.Base.Player", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.QuestionTypes.RevealQuestion", b =>
                {
                    b.HasOne("Quizzer.DataModels.Models.QuestionBase", null)
                        .WithOne()
                        .HasForeignKey("Quizzer.DataModels.Models.QuestionTypes.RevealQuestion", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
