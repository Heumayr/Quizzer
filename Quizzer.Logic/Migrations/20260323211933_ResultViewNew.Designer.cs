...
namespace Quizzer.Logic.Migrations
{
    ...
    [Migration("20260323211933_ResultViewNew")]
    partial class ResultViewNew
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.Base.QuestionResult", b =>
                {
                    ...
                    b.Property<Guid?>("GameGridCoordinateId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GameGridCoordinateId1");
            ...
            modelBuilder.Entity("Quizzer.DataModels.Models.Base.QuestionResult", b =>
                {
                    ...
                    b.HasOne("Quizzer.DataModels.Models.Base.GameGridCoordinate", null)
                        .WithMany("QuestionResults")
                        .HasForeignKey("GameGridCoordinateId1");
