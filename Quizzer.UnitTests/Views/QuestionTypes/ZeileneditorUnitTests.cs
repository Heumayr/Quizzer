...
namespace Quizzer.UnitTests.Views.QuestionTypes
{
    ...
    {
        /// <summary>
        /// Ein ViewModel mit frischer Frage. <b><c>internal</c>, damit
        /// <see cref="AufdeckDialogUnitTests"/> denselben Aufbau benutzt, statt ihn zu
        /// verdoppeln</b> - die Aufdeck-Zusicherungen sind 2026-09-07 hierher ausgezogen,
        /// weil diese Datei ueber die Groessen-Obergrenze gewachsen war.
        /// </summary>
        internal static EditQuestionViewModel Mit(QuestionType typ, Action<QuestionBase>? weiter = null)
        {
